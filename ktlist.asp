					...
					<tr style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                      <TD height="49" align="center" bgcolor="#0099FF" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
						<p align="left" class="title" style="margin-top: 0; margin-bottom: 0">
										<font color="#006699" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font><span style="font-weight: 700"><font face="微软雅黑" color="#FFFFFF">在线课堂</font></span></TD>
                    </tr>
					<tr style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                                  ...
                                  <TBODY style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="48" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										...
										<font color="#004993" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font><font face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-size: 16px; font-weight: 700; border: 0px none; margin: 0px; padding: 0px" href="zxktsp.asp?type=75">８分钟慕课</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="13" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 7px">
										<font color="#004993" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font><font face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-size: 16px; font-weight: 700; border: 0px none; margin: 0px; padding: 0px" href="zxktsp.asp?type=76">课件共享</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font><font face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight: 700; font-size: 16px; border: 0px none; margin: 0px; padding: 0px" href="zxktsp.asp?type=74">视频录播</a></font><font color="#004993" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font></TD>
                                    ...
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										...
										<font face="微软雅黑">　　<a href="zxktsp.asp?type=74&type2=35" style="text-decoration: none">精彩片段</a>　　<a href="zxktsp.asp?type=74&type2=36" style="text-decoration: none">主题讲解</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font><font face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight: 700; font-size: 16px; border: 0px none; margin: 0px; padding: 0px" href="ktsytz.asp?type=69">视野拓展</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="30" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font face="微软雅黑">　　<a href="ktlist.asp?type=69&type2=17" style="text-decoration: none">课前必读</a>　　<a href="ktlist.asp?type=69&type2=18" style="text-decoration: none">背景知识</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="30" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font face="微软雅黑">　　<a href="ktlist.asp?type=69&type2=34" style="text-decoration: none">课后补充</a>　　<span style="color: rgb(0, 0, 0); font-style: normal; font-variant: normal; letter-spacing: normal; line-height: 20.8px; orphans: auto; text-align: -webkit-left; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px"><font color="#005BB7"><a href="ktlist.asp?type=69&type2=44" style="text-decoration: none">人工智能口语训练营</a></font></span></font></TD>
						...
						<table border="0" width="302" cellspacing="0" cellpadding="0" height="40" bgcolor="#004993" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
							...
							<tr style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
								...
								<p class="xuesheng" style="margin-top: 0; margin-bottom: 0" align="left">
										<font color="#006699" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font><span style="border:0px none; margin:0px; padding:0px; font-weight: 700; font-size:16px"><font color="#FFFFFF" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">团队动态</font></span></td>
							</tr>
							<tr style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
...
border=0 height="49">
                  <TBODY>
                    <TR> 
                      <TD width="694" align="right" height="44">
                        ...
                        &gt;&gt; </font> 
						<a href="ktsytz.asp?type=<%=bigclassid%>" style="text-decoration: none">
...
%>
                        ...
                        align=left width="716"> <font face="微软雅黑">                             
                               ...
                               <a href="ktview.asp?id=<% =rs("id") %>" style="text-decoration: none">
                        ...
                        align=center width="134" class="shuye1"> 
								<p class="shuye1" style="margin-top: 0; margin-bottom: 0"> <% =year(rs("infotime")) %>-<% =month(rs("infotime")) %>-<% =day(rs("infotime")) %> </TD>
                            </TR>
...
%>
    ...
    response.write "<a href=ktlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>首页</FONT></a>&nbsp;"
    response.write "<a href=ktlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>上一页</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=ktlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>下一页</FONT></a> <a href=ktlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>尾页</FONT></a>"
  end if
