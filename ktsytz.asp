...
smallclassid=left(smallclassid,8)
	if bigclassid="" then '
  		response.write "<br><p align=center><font color='red'>¶Ô²»Æð£¬Äã·ÃÎÊµÄÎÄ¼þ²»´æÔÚ1¡£</font></p>"
		response.end
	elseif  not isNumeric(bigclassid) then
  		response.write "<br><p align=center><font color='red'>¶Ô²»Æð£¬Äã·ÃÎÊµÄÎÄ¼þ²»´æÔÚ2¡£</font></p>"
		response.end
	else
	...
	if  not isNumeric(smallclassid) then
	    response.write "<br><p align=center><font color='red'>¶Ô²»Æð£¬Äã·ÃÎÊµÄÎÄ¼þ²»´æÔÚ3¡£</font></p>"
		response.end
	else
        ...
        response.write "<br><p align=center><font color='red'>¶Ô²»Æð£¬Äã·ÃÎÊµÄÎÄ¼þ²»´æÔÚ4¡£</font></p>"
        response.end
        end if
        rss.Close
        set rss=nothing
					...
					<tr>
                      <TD height="49" align="center" bgcolor="#0099FF">
						<p align="left" class="title" style="margin-top: 0; margin-bottom: 0">
										<font color="#006699" face="Î¢ÈíÑÅºÚ">¡¡</font><span style="font-weight: 700"><font color="#FFFFFF" face="Î¢ÈíÑÅºÚ">ÔÚÏß¿ÎÌÃ</font></span></TD>
                    </tr>
					<tr>
                                  ...
                                  <TBODY style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="48" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										...
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-size: 16px; font-weight: 700; border: 0px none; margin: 0px; padding: 0px" href="zxktsp.asp?type=75">£¸·ÖÖÓÄ½¿Î</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="13" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 7px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-size: 16px; font-weight: 700; border: 0px none; margin: 0px; padding: 0px" href="zxktsp.asp?type=76">¿Î¼þ¹²Ïí</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight: 700; font-size: 16px; border: 0px none; margin: 0px; padding: 0px" href="zxktsp.asp?type=74">ÊÓÆµÂ¼²¥</a></font><font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<p class="text" style="margin-top: 0; margin-bottom: 0">
										<font face="Î¢ÈíÑÅºÚ">¡¡¡¡<a href="zxktsp.asp?type=74&type2=35" style="text-decoration: none">¾«²ÊÆ¬¶Î</a>¡¡¡¡<a href="zxktsp.asp?type=74&type2=36" style="text-decoration: none">Ö÷Ìâ½²½â</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight: 700; font-size: 16px; border: 0px none; margin: 0px; padding: 0px" href="ktsytz.asp?type=69">ÊÓÒ°ÍØÕ¹</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="30" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font face="Î¢ÈíÑÅºÚ">¡¡¡¡<a href="ktlist.asp?type=69&type2=17" style="text-decoration: none">¿ÎÇ°±Ø¶Á</a>¡¡¡¡<a href="ktlist.asp?type=69&type2=18" style="text-decoration: none">±³¾°ÖªÊ¶</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="30" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font face="Î¢ÈíÑÅºÚ">¡¡¡¡<a href="ktlist.asp?type=69&type2=34" style="text-decoration: none">¿Îºó²¹³ä</a>¡¡¡¡<span style="color: rgb(0, 0, 0); font-style: normal; font-variant: normal; letter-spacing: normal; line-height: 20.8px; orphans: auto; text-align: -webkit-left; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px"><font color="#005BB7"><a href="ktlist.asp?type=69&type2=44" style="text-decoration: none">ÈË¹¤ÖÇÄÜ¿ÚÓïÑµÁ·Óª</a></font></span></font></TD>
...
demo.onmouseout=function() {MyMar=setInterval(Marquee,speed)} 
              ...
              <TD width="1"></TD>
				...
				<TABLE cellSpacing=0 cellPadding=0 width="867" 
border=0 height="50">
                  <TBODY>
                    <TR> 
                      ...
                      <TD width="485" background="fl/cp1.gif">¡¡</TD>
                    </TR>
                    <TR> 
                        ...
                        <TBODY>
                          <TR> 
                            <TD width="3%" height="40" align="left" class="xuesheng" bgcolor="#E9EAE8"> 
                              <div align="center">
								<font color="#005BB7">¡ò</font></div></TD>
                            ...
                            <TD width="7%" align="left" bgcolor="#E9EAE8"><a href="ktlist.asp?type=<%=bigclassid%>&type2=<%=rsSmallClass("SmallClassid")%>">
							<font color="#005BB7">
							<IMG height=11 
							...
							<TABLE width="850" border="0" align="center" cellPadding=0 cellSpacing=0>
                                <TBODY>
                                  <TR> 
									...
									<font face="Î¢ÈíÑÅºÚ">¡ñ</font></TD>
                                    <TD width="616" height="20" class=shuye align="left">
									<p class="shuye" style="line-height: 200%; margin-top: 0; margin-bottom: 0"><a href="ktview.asp?id=<% =ors("id") %>" style="text-decoration: none" > 
                                      <font color="#3D3D3D"> 
                                      <% =ors("title") %></p>
                                      </font>
                                      </a>
...
%>
                            <TR> 
                                    <TD width=20 height="3" vAlign=middle class=shuye1 align="left">
									<p align="center">
									<font face="Î¢ÈíÑÅºÚ">¡ñ</font></TD>
                                    <TD width="646" height="20" class=shuye align="left">
									<p class="shuye" style="line-height: 200%; margin-top: 0; margin-bottom: 0"><a href="jxpjview.asp?id=<% =ors("id") %>" style="text-decoration: none" > 
                                      <font color="#005BB7"> 
                                      <% =ors("title") %></p>
                                      </font>
                                      </a>
                                      </TD>
                                    <TD width="95" height="8" class=listbg align="left">
									</TD>
                                  </TR>
                                  <TR> 
									...
									<p class="index2" style="line-height: 200%; margin: 0 16px; text-indent:32px" align="right">·¢²¼Ê±¼ä£º<% =year(ors("infotime")) %>-<% =month(ors("infotime")) %>- <% =day(ors("infotime")) %></TD>
                                  </TR>
                                  <TR> 
                                    <TD height="2" colspan="3" vAlign=middle class=listb background="images/newx_fenge.gif"></TD>
                                  </TR>
                          ...
                          <table width="865" border="0">
                            <tr> 
                              <td height="40"><div align="center"> 
                                  <font color="#515753" face="Î¢ÈíÑÅºÚ"> 
                                  <%if Page<2 then      
    response.write "Ê×Ò³ ÉÏÒ»Ò³&nbsp;"
  else
    response.write "<a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>Ê×Ò³</FONT></a>&nbsp;"
    response.write "<a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>ÉÏÒ»Ò³</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "ÏÂÒ»Ò³ Î²Ò³"
  else
    response.write "<a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>ÏÂÒ»Ò³</FONT></a> <a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>Î²Ò³</FONT></a>"
  end if
   response.write "&nbsp;Ò³´Î£º<strong><font color=red>"&Page&"</font>/"&rs.pagecount&"</strong>Ò³ "
    response.write "&nbsp;¹²<b><font color='#FF0000'>"&rs.recordcount&"</font></b>ÌõÐÅÏ¢ <b>"&rs.pagesize&"</b>ÌõÐÅÏ¢/Ò³"
%>
                                </font>
                                </div></td>
                            </tr>
