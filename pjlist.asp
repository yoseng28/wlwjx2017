					...
					<tr style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                      <TD height="49" align="center" bgcolor="#0099FF" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
						<p align="left" class="title" style="margin-top: 0; margin-bottom: 0">
										<font color="#006699" face="微软雅黑" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">　</font><span style="border:0px none; margin:0px; padding:0px; font-weight: 700; "><font color="#FFFFFF" face="微软雅黑" style="border: 0px none; margin: 0px; padding: 0px">教学评价</font></span></TD>
                    </tr>
					<tr style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                                  ...
                                  <TBODY>
                                    <TR> 
                                      <TD align="left" height="48" background="bj.jpg" style="font-size: 10pt; line-height: 22px; font-family: arial">
										...
										<font color="#004993" face="微软雅黑">　</font><font face="微软雅黑"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight:700" href="zjsp.asp?type=83">国外专家评价</a></font></TD>
                                      
                                    </TR>
                                    <TR> 
                                      <TD align="left" height="13" background="bj.jpg" style="font-size: 10pt; line-height: 22px; font-family: arial">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 0; line-height:200%">
										<font color="#004993" face="微软雅黑">　</font><font face="微软雅黑"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight:700" href="zjsp.asp?type=84">国内专家评价</a></font></TD>
                                      
                                    </TR>
                                    <TR> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 10pt; line-height: 22px; font-family: arial">
										<p class="xuesheng" style="line-height: 200%; margin-top: 0; margin-bottom: 0">
										<font color="#004993" face="微软雅黑">　</font><font face="微软雅黑"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight: 700" href="pjlist.asp?type=71&type2=25">团队成员互评</a></font></TD>
                                      
                                    </TR>
                                    <TR> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 10pt; line-height: 22px; font-family: arial">
										<p class="xuesheng" style="line-height: 200%; margin-top: 0; margin-bottom: 0">
										<font face="微软雅黑">　<img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none; font-weight: 700" href="pjlist.asp?type=71&type2=26">学生评价反馈</a></font></TD>
...
%>
                        ...
                        align=left width="716"> <font face="微软雅黑">                             
                               ...
                               <a href="jxpjview.asp?id=<% =rs("id") %>" style="text-decoration: none">
								<p class="shuye1" style="line-height: 200%; margin-top: 0; margin-bottom: 0; margin-left:16px"><a href="jxpjview.asp?id=<% =rs("id") %>" style="text-decoration: none" > 
                              ...
                              <TD height="18" 
                        align=center width="134" class="shuye1"> <% =year(rs("infotime")) %>-<% =month(rs("infotime")) %>-<% =day(rs("infotime")) %> </TD>
                            </TR>
...
%>
    ...
    response.write "<a href=pjlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>首页</FONT></a>&nbsp;"
    response.write "<a href=pjlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>上一页</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=pjlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>下一页</FONT></a> <a href=pjlist.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>尾页</FONT></a>"
  end if
