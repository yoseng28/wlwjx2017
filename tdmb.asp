					...
					<tr>
                      <TD height="49" align="center" bgcolor="#0099FF">
						<p align="left" class="title" style="margin-top: 0; margin-bottom: 0">
										<font color="#006699" face="微软雅黑">　</font><span style="font-weight: 700"><font color="#FFFFFF" face="微软雅黑">团队定位</font></span></TD>
                    </tr>
					<tr>
                                  ...
                                  <TBODY>
                                    <TR> 
                                      <TD align="left" height="42" background="bj.jpg">
										...
										<font color="#004993" face="微软雅黑">　</font><font face="微软雅黑"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;&nbsp;</span><a style="text-decoration: none" href="tdmb.asp?type=1">团队定位</a></font></TD>
                      ...
                      <TABLE width="847" border=0 cellPadding=0 cellSpacing=0 style="BORDER-bottom: #FF9900 1px solid;">
                        <TBODY>
                          <TR> 
                            ...
                            <TD width="38%"><B><a  href="tdmblist.asp?type=<%=bigclass%>&type2=<%=rsSmallClass("SmallClassName")%>"><SPAN style="FONT-SIZE: 14px"><font color="205081"><%=rsSmallClass("SmallClassName")%></font></SPAN></a></B></TD>
                            <TD width="51%" align=middle>　</TD>
                            <TD width="7%"><a href="tdmblist.asp?type=<%=bigclassid%>&type2=<%=rsSmallClass("SmallClassid")%>">
							<IMG height=11 
   ...
   %>
                                ...
                                <TBODY>
                                  <TR> 
                                    ...
                                    <TD width="679" height="30" class=listbg align="left"><a href="tdmbview.asp?id=<% =ors("id") %>" > 
                                      <font color="#404A53"> 
                                      <% =ors("title") %>
                                      </font>
                                      </a>
...
%>
    ...
    response.write "<a href=tdmb.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>首页</FONT></a>&nbsp;"
    response.write "<a href=tdmb.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>上一页</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=tdmb.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>下一页</FONT></a> <a href=tdmb.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>尾页</FONT></a>"
  end if
