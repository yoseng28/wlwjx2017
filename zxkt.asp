                                  ...
                                  <TBODY style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="48" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										...
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="border:0px none; margin:0px; padding:0px; text-decoration: none; font-size:16px" href="ktlist.asp?type=69&type2=17">£¸·ÖÖÓÄ½¿Î</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="13" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 7px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="border:0px none; margin:0px; padding:0px; text-decoration: none; font-size:16px" href="ktlist.asp?type=69&type2=18">¿Î¼þ¹²Ïí</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span></font><a href="jiaoxueview.asp?id=223" style="border:0px none; margin:0px; padding:0px; text-decoration: none; font-weight:700; font-size:16px"><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">ÊÓÆµÂ¼²¥</font></a><font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="border:0px none; margin:0px; padding:0px; text-decoration: none; font-weight: 700; font-size:16px" href="ktlist.asp?type=69&type2=33">ÊÓÒ°ÍØÕ¹</a></font></TD>
                      ...
                      <TABLE width="850" border=0 cellPadding=0 cellSpacing=0 style="BORDER-bottom: #FF9900 1px solid;">
                        <TBODY>
                          <TR> 
                            ...
                            <TD width="7%" align="left" bgcolor="#E9EAE8"><a href="kylist.asp?type=<%=bigclassid%>&type2=<%=rsSmallClass("SmallClassid")%>">
							<font color="#005BB7">
							<IMG height=11 
							...
							<TABLE width="850" border="0" align="center" cellPadding=0 cellSpacing=0>
                                <TBODY>
                                  <TR> 
									...
									<p class="shuye" style="line-height: 200%; margin-top: 0; margin-bottom: 0"><a href="tdmbview.asp?id=<% =ors("id") %>" style="text-decoration: none" > 
                                      <font color="#3D3D3D"> 
                                      <% =ors("title") %></p>
                                      </font>
                                      </a>
...
%>
    ...
    response.write "<a href=zxkt.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>Ê×Ò³</FONT></a>&nbsp;"
    response.write "<a href=zxkt.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>ÉÏÒ»Ò³</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "ÏÂÒ»Ò³ Î²Ò³"
  else
    response.write "<a href=zxkt.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>ÏÂÒ»Ò³</FONT></a> <a href=zxkt.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>Î²Ò³</FONT></a>"
  end if
