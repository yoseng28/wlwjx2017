                ...
                <table border="0" width="240" cellspacing="0" height="644">
					<tr>
                      <TD height="60" align="center" bgcolor="#0099FF">
						<p class="anli" align="left"><font color="#4D4D4D">¡¡</font><font color="#FFFFFF">ÔÚÏß¿ÎÌÃ</font></TD>
                    </tr>
                                   

					<tr>
						<td bgcolor="#FFFFFF"> 
                <table border="0" width="288" cellspacing="0" height="195">
                <tr>
                                      <TD align="left" height="195" class="text">
                                  ...
                                  <TBODY style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
                                    ...
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="border:0px none; margin:0px; padding:0px; text-decoration: none; font-weight:700; font-size:16px" href="zxktsp.asp?type=74">ÊÓÆµÂ¼²¥</a></font><font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font></TD>
                                    ...
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										...
										¡¡¡¡ ¡¡<a href="zxktsp.asp?type=74&type2=35" style="text-decoration: none">¾«²ÊÆ¬¶Î</a>¡¡¡¡<a href="zxktsp.asp?type=74&type2=36" style="text-decoration: none">Ö÷Ìâ½²½â</a></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										<font color="#004993" face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">¡¡</font><font face="Î¢ÈíÑÅºÚ" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><img border="0" src="images/about1.jpg" width="19" height="27" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"><span class="Apple-converted-space">&nbsp;</span><a style="border:0px none; margin:0px; padding:0px; text-decoration: none; font-weight: 700; font-size:16px" href="ktsytz.asp?type=69">ÊÓÒ°ÍØÕ¹</a></font></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="30" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										¡¡¡¡¡¡<a href="ktlist.asp?type=69&type2=17" style="text-decoration: none">¿ÎÇ°±Ø¶Á</a>¡¡¡¡<a href="ktlist.asp?type=69&type2=18" style="text-decoration: none">±³¾°ÖªÊ¶</a></TD>
                                      
                                    </TR>
                                    <TR style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px"> 
                                      <TD align="left" height="30" background="bj.jpg" style="font-size: 16px; border: 0px none; margin: 0px; padding: 0px">
										¡¡¡¡¡¡<a href="ktlist.asp?type=69&type2=34" style="text-decoration: none">¿Îºó²¹³ä</a></TD>
