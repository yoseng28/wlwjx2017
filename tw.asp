...
%>
    ...
    response.write "<a href=tw.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><font color=red>首页</font></a>&nbsp;"
    response.write "<a href=tw.asp?type="&bigclassid&"&type2="&smallclass&"&page=" & Page-1 & "><font color=red>上一页</font></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=tw.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<font color=red>下一页</font></a> <a href=tw.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><font color=red>尾页</font></a>"
  end if
                                ...
                                cellPadding=0 cellSpacing=0 borderColor=#b2b2b2>
                                              <TBODY>
                                                <TR> 
                                                  <TD width="187" height="187" bgColor=#ffffff>
													<p align="center" style="line-height: 200%; margin-top: 0; margin-bottom: 0"><a href="twview.asp?id=<%= RS("id") %>" >
                                        ...
                                        <TR> 
                                          <TD height="40" align="center" class="text">
                                            ...
                                            <font face="微软雅黑"> 
                                            <a style="text-decoration: none" href="twview.asp?id=<%= RS("id") %>"> 
...
next %>
    ...
    response.write "<a href=tw.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><font color=red>首页</font></a>&nbsp;"
    response.write "<a href=tw.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><font color=red>上一页</font></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
