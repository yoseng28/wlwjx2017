                      ...
                      <TABLE width="850" border=0 cellPadding=0 cellSpacing=0 style="BORDER-bottom: #FF9900 1px solid;">
                        <TBODY>
                          <TR> 
                            ...
                            <TD width="7%" align="left" bgcolor="#E9EAE8"><a href="jylist.asp?type=<%=bigclassid%>&type2=<%=rsSmallClass("SmallClassid")%>">
							<font color="#005BB7">
							<IMG height=11 
							...
							<TABLE width="850" border="0" align="center" cellPadding=0 cellSpacing=0>
                                <TBODY>
                                  <TR> 
                                    ...
                                    <TD width="616" height="40" class=shuye align="left">
									<p class="shuye" style="line-height: 200%; margin-top: 0; margin-bottom: 0"><a href="cxjyview.asp?id=<% =ors("id") %>" style="text-decoration: none" > 
                                      <font color="#3D3D3D"> 
                                      <% =ors("title") %></p>
                                      </font>
                                      </a>
...
%>
    ...
    response.write "<a href=cxjy.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>首页</FONT></a>&nbsp;"
    response.write "<a href=cxjy.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>上一页</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=cxjy.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>下一页</FONT></a> <a href=cxjy.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>尾页</FONT></a>"
  end if
