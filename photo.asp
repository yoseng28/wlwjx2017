...
border=0 height="68" bgcolor="#FFFFFF">
                  <TBODY>
                    <TR> 
                      <TD width="845" height="63" align="left" style="BORDER-BOTTOM: #CFCFCF 0px dashed" background="fl/tibj.gif"> 
...
<TABLE width="260" border=0 align="center" 
                              cellPadding=2 cellSpacing=0>
                                ...
                                cellPadding=3 cellSpacing=0 borderColor=#b2b2b2>
                                              <TBODY>
                                                <TR> 
                                                  <TD width="240" height="200" bgColor=#ffffff>
													...
													<img src="../images/wupic.jpg" width="247" height="259" border="0"></a></TD>
                                                </TR>
                                              </TBODY>
                                            </TABLE>
                                            <span class="bh"> 
											...
											<TABLE width="247" height="189" border=1 
                                cellPadding=0 cellSpacing=0 borderColor=#b2b2b2>
                                              <TBODY>
                                                <TR> 
                                                  <TD width="243" height="187" bgColor=#ffffff>
													<p align="center" style="line-height: 200%; margin-top: 0; margin-bottom: 0"><a href="productview.asp?id=<%= RS("id") %>" >
													<img src="<% Response.Write (""&RS("ProductImages")&"")%>" width="251" height="259" border="0"></a></TD>
                                                </TR>
                                              </TBODY>
                                            </TABLE>
                                            <span class="bh"> 
...
next %>
    ...
    response.write "<a href=photo.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><font color=red>首页</font></a>&nbsp;"
    response.write "<a href=photo.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><font color=red>上一页</font></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=photo.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<font color=red>下一页</font></a> <a href=photo.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><font color=red>尾页</font></a>"
  end if
   response.write "&nbsp;页次：<strong><font color=red>"&Page&"</font>/"&rs.pagecount&"</strong>页 "
    response.write "&nbsp;共<b><font color='#FF0000'>"&rs.recordcount&"</font></b>条 <b>"&rs.pagesize&"</b>条/页"
%>
