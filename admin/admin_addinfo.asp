  ...
  <form name="addNEWS" method="post" action="addinfo_ok.asp">
    <tr> 
      <td height="25" colspan="3" align="center" background="images/b1.gif"><strong><span class="style1"><font color="#FFFFFF">添 
        加 内 容</font></span> </strong></td>
    </tr>
    <tr> 
      <td width="84" height="20" bgcolor="#f9f9f9"><font color="#FF0000">*</font>标题：</td>
      <td colspan="2" bgcolor="#f9f9f9"> <input name="title" type="text" class="input" size="30"></td>
    </tr>
    <tr> 
      <td height="20" bgcolor="#f9f9f9"><font color="#FF0000">*</font>类别：</td>
    ...
    <tr> 
      <td height="20" bgcolor="#f9f9f9">首页幻灯图片：</td>
    ...
    <tr> 
      <td height="25" valign="top" bgcolor="#f9f9f9"><font color="#FF0000">*</font>文章
：</td>
...
%>
    ...
    <tr> 
      <td height="20" bgcolor="#f9f9f9"><font color="#FF0000">*</font>发布人：</td>
      <td colspan="2" bgcolor="#f9f9f9"> <input name="user" type="text" class="input" value="管理员" size="30"></td>
    </tr>
    <tr> 
      <td height="25" bgcolor="#f9f9f9">首页图片显示：</td>
