...
<table width="80%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br>
      <a href="ClassManage.asp"><strong>类 别 设 置</strong></a> <br> <form name="form1" method="post" action="ClassModifySmall.asp">
        <p>&nbsp;</p>
        <table width="350" border="1" align="center" cellpadding="4" cellspacing="1" bordercolor="#376ed0" class="border">
          <tr bgcolor="#999999" class="title"> 
            <td height="25" colspan="2" align="center" background="images/b1.gif"><strong>修改小类名称</strong></td>
          </tr>
          ...
          <tr bgcolor="#f9f9f9" class="tdbg"> 
            <td height="22"><strong>小类名称：</strong></td>
            <td> 
