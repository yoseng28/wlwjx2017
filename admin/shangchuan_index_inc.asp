...
%>
<%
Const MaxFileSize=200000       '上传文件大小限制,单位K
Const SaveUpFilesPath="../uppic"        '存放上传文件的目录
Const UpFileType="gif|jpg|bmp|png|swf|doc|docx|flv|pdf|rar|ppt|pptx|xls|zip|caj"        '允许的上传文件类型
%>
