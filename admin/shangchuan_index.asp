...
<form action="shangchuan_index_inc.asp" method="post" name="form1" onSubmit="return check()" enctype="multipart/form-data">
  ...
  <input name="picID" type="hidden" id="picID" value="<%=Clng(trim(request("picID")))%>">
</form>
</body>
</html>
