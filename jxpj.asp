					...
					<tr>
                      <TD height="49" align="center" bgcolor="#0099FF">
						<p align="left" class="title" style="margin-top: 0; margin-bottom: 0">
										<font color="#006699" face="微软雅黑">　</font><span style="font-weight: 700"><font color="#FFFFFF" face="微软雅黑">教学评价</font></span></TD>
                    </tr>
					<tr>
                                  ...
                                  <TBODY>
                                    <TR> 
                                      <TD align="left" height="48" background="bj.jpg">
										...
										<font color="#004993" face="微软雅黑">　</font><font face="微软雅黑"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none" href="pjlist.asp?type=71&type2=23">国外专家评价</a></font></TD>
                                      
                                    </TR>
                                    <TR> 
                                      <TD align="left" height="13" background="bj.jpg">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 0; line-height:200%">
										<font color="#004993" face="微软雅黑">　</font><font face="微软雅黑"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none" href="pjlist.asp?type=71&type2=24">国内专家评价</a></font></TD>
                      ...
                      <TABLE width="850" border=0 cellPadding=0 cellSpacing=0 style="BORDER-bottom: #FF9900 1px solid;">
                        <TBODY>
                          <TR> 
                            ...
                            <TD width="7%" align="left" bgcolor="#E9EAE8"><a href="pjlist.asp?type=<%=bigclassid%>&type2=<%=rsSmallClass("SmallClassid")%>">
							<font color="#005BB7">
							<IMG height=11 
...
%>
    ...
    response.write "<a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>首页</FONT></a>&nbsp;"
    response.write "<a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>上一页</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>下一页</FONT></a> <a href=jxpj.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>尾页</FONT></a>"
  end if
