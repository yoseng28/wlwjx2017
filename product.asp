              ...
              <TD width="252" vAlign=top bgcolor="#ffffff"> 
                ...
                <table border="0" width="240" cellspacing="0" height="644">
					<tr>
                      <TD height="60" align="center" background="fl/fanwei.gif">
						<p class="anli" align="left"><font color="#4D4D4D">　产品分类</font></TD>
                    </tr>
                ...
                <tr>
                                      <TD align="left" height="37" background="bj.jpg" class="text">
										...
										<font face="微软雅黑">&nbsp;<img border="0" src="images/about1.jpg" width="19" height="27"> </font><a style="text-decoration: none" href="product.asp?type=31&type2=30">
										<font face="微软雅黑">家智洁电动马桶</font></a></TD>
					...
					<tr>
                                      <TD align="left" height="42" background="bj.jpg" class="text">
										<p style="margin-top: 0; margin-bottom: 0">
										<font face="微软雅黑">&nbsp;<img border="0" src="images/about1.jpg" width="19" height="27"> </font><a style="text-decoration: none" href="product.asp?type=31&type2=31">
										<font face="微软雅黑">家智洁污水提升机</font></a></TD>
                                      
                                    </tr>
					<tr>
                                      <TD align="left" height="41" background="bj.jpg" class="text">
										<font face="微软雅黑">&nbsp;<img border="0" src="images/about1.jpg" width="19" height="27"> </font>
					...
					<tr>
                                      <TD align="left" height="43" background="bj.jpg" class="text">
										...
										<a href="product.asp?type=31&type2=72" style="text-decoration: none">淋浴器</a></font></TD>
				...
				<p align="left" style="line-height: 200%; margin-top: 0; margin-bottom: 0">
				<font face="微软雅黑" color="#666666" >
				地址：<% =address %><br>
				手机：<% =phone  %></font></p>
				<p align="left" style="line-height: 200%; margin-top: 0; margin-bottom: 0">
				<font face="微软雅黑" color="#666666">电话：</font><font face="微软雅黑" color="#404A53"><% =fax %></font><p style="line-height: 200%; margin-top: 0; margin-bottom: 0">
...
%>
    ...
    response.write "<a href=product.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><font color=red>首页</font></a>&nbsp;"
    response.write "<a href=product.asp?type="&bigclassid&"&type2="&smallclass&"&page=" & Page-1 & "><font color=red>上一页</font></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=product.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<font color=red>下一页</font></a> <a href=product.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><font color=red>尾页</font></a>"
  end if
...
next %>
    ...
    response.write "<a href=product.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><font color=red>首页</font></a>&nbsp;"
    response.write "<a href=product.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><font color=red>上一页</font></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
