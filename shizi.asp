...
xsfs=oRSxs("xsfs")
   ...
   %>
	...
	<BODY topMargin=0 leftmargin="0" link="#666666" vlink="#666666" alink="#666666" class="shuye" bgcolor="#FFFFFF">
		...
		<div align="center">
			<TABLE cellSpacing=0 cellPadding=0 width=1080 bgColor=#ffffff align="center" border=0>
				<TBODY>
					<TR>
						<TD width="1080">
							<div align="center">
									...
									<TBODY>
										<TR>
												...
												<table border="0" width="260" cellspacing="0" height="436" style="BORDER-TOP: #808080 0px solid;BORDER-LEFT: #808080 0px solid;BORDER-right: #808080 0px solid;BORDER-bottom: #808080 0px solid;">
													...
													<tr>
														<TD height="99" bgcolor="#FFFFFF">
															<TABLE cellSpacing=0 cellPadding=0 width="91%" border=0 height="43">
																<TBODY>
																	<TR>
											...
											<TD width="835" vAlign=top style="BORDER-TOP: #C5CED7 1px solid;BORDER-LEFT: #FFFFF 0px solid;BORDER-right: #C5CED7 1px solid;BORDER-bottom: #C5CED7 0px solid;">
												<TABLE cellSpacing=0 cellPadding=0 width="832" border=0>
													<TBODY>
														<TR>
...
%>
													<tr>
														<td class=lst01 height="20" colspan="2">
                                      ...
                                      <% if RS("ProductImages")="" then %>
																							...
																							<TABLE width="130" height="110" border=1 cellPadding=3 cellSpacing=0 borderColor=#b2b2b2>
																								<TBODY>
																									<TR>
																										<TD width="120" height="108" bgColor=#ffffff>
																											<a href="shiziview.asp?id=<%= RS(" id ") %>" target="_blank"><img src="images/wupic.jpg" width="120" height="100" border="0"></a>
																										</TD>
																									</TR>
																								</TBODY>
																							</TABLE>
                                      ...
                                      <% else %>
																							...
																							<TABLE width="130" height="110" border=1 cellPadding=3 cellSpacing=0 borderColor=#b2b2b2>
																								<TBODY>
																									<TR>
																										<TD width="120" height="108" bgColor=#ffffff>
																											<a href="shiziview.asp?id=<%= RS(" id ") %>" target="_blank"><img src="<% Response.Write (" "&RS("ProductImages ")&" ")%>" width="120" height="100" border="0"></a>
																										</TD>
																									</TR>
																								</TBODY>
																							</TABLE>
...
%>
							   ...
							   %>
                                            ...
                                            <% if trim(RS("ProductImages"))="" then %>
																												...
																												<div align="center">
																													<TABLE width="815" height="177" border=0 cellPadding=3 cellSpacing=0 borderColor=#b2b2b2>
																														<TBODY>
																															<TR>
																																<TD width="235" height="88" bgColor=#ffffff>
																																	<a href="shiziview.asp?id=<%= RS(" id ") %>">
																																		<img src="images/wupic.jpg" width="359" height="282" border="0" style="border-style: solid; border-width: 0px; "></a>
																																</TD>
