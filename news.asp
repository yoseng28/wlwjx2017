                      ...
                      <TABLE width="847" border=0 cellPadding=0 cellSpacing=0 style="BORDER-bottom: #FF9900 1px solid;">
                        <TBODY>
                          <TR> 
                            ...
                            <TD width="38%"><B><a  href="list.asp?type=<%=bigclass%>&type2=<%=rsSmallClass("SmallClassName")%>"><SPAN style="FONT-SIZE: 14px"><font color="205081"><%=rsSmallClass("SmallClassName")%></font></SPAN></a></B></TD>
                            <TD width="51%" align=middle>　</TD>
                            <TD width="7%"><a href="list.asp?type=<%=bigclassid%>&type2=<%=rsSmallClass("SmallClassid")%>">
							<IMG height=11 
   ...
   %>
                                ...
                                <TBODY>
                                  <TR> 
                                    ...
                                    <TD width="679" height="30" class=listbg align="left"><a href="newsview.asp?id=<% =ors("id") %>" > 
                                      <font color="#404A53"> 
                                      <% =ors("title") %>
                                      </font>
                                      </a>
...
%>
                        ...
                        align=left class="shuye"><div align="center"><b><font color="#404A53">
                              ...
                              <TD height="30" 
                        align=left width="679" class="shuye"> 
                              ...
                              <TD height="30" 
                        align=left width="111" class="shuye"> 
...
%>
    ...
    response.write "<a href=news.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>首页</FONT></a>&nbsp;"
    response.write "<a href=news.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>上一页</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=news.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>下一页</FONT></a> <a href=news.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>尾页</FONT></a>"
  end if
