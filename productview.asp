...
.anli1       { font-family: Î¢ÈíÑÅºÚ; font-size: 12pt; }
              ...
              <TD width="260" vAlign=top bgcolor="#FFFFFF"  style="BORDER-TOP: #808080 0px solid;BORDER-LEFT: #808080 0px solid;BORDER-right: #808080 1px solid;BORDER-bottom: #808080 0px solid;"> 
                ...
                <table border="0" width="240" cellspacing="0" height="644">
					<tr>
                      <TD height="60" align="center" bgcolor="#0099FF">
						<p class="anli" align="left"><font color="#4D4D4D">¡¡</font><span style="font-weight: 700"><font color="#FFFFFF" face="Î¢ÈíÑÅºÚ">ÍÅ¶Ó¹¹³É</font></span></TD>
                    </tr>
                ...
                <tr>
                              ...
                              border=0 height="87" >
                                  <TBODY>
                                    <TR> 
                                      <TD align="left" height="40" background="bj.jpg" class="anli1">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 0">
										<font color="#004993" face="Î¢ÈíÑÅºÚ">¡¡</font><font face="Î¢ÈíÑÅºÚ"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a href="shizi.asp?type=45" style="text-decoration: none">Ñ§¿Æ´øÍ·ÈË</a></font></TD>
                                      
                                    </TR>
                                    <TR> 
                                      <TD align="left" height="40" background="bj.jpg" class="anli1">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 0">
										<font color="#004993" face="Î¢ÈíÑÅºÚ">¡¡</font><font face="Î¢ÈíÑÅºÚ"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a href="shizi.asp?type=48" style="text-decoration: none">³ÉÔ±¼ò½é</a></font></TD>
                                      
                                    </TR>
                                    <TR> 
                                      <TD align="left" height="40" background="bj.jpg" class="anli1">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 0">
										<font color="#004993" face="Î¢ÈíÑÅºÚ">¡¡</font><font face="Î¢ÈíÑÅºÚ"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a href="tdgc.asp?type=60" style="text-decoration: none">ÍÅ¶Ó³É³¤</a></font></TD>
                                      
                                    </TR>
                                    <TR> 
                                      <TD align="left" height="40" background="bj.jpg" class="anli1">
										<p class="xuesheng" style="margin-top: 0; margin-bottom: 0">
										<font face="Î¢ÈíÑÅºÚ">¡¡<img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span><a style="text-decoration: none" href="tdgc.asp?type=61">ÍÅ¶Ó¹ÜÀí</a></font></TD>
                              ...
                              cellPadding=2 border=0>
                                <TBODY>
                                  <TR> 
									...
									<TABLE width="250" height="210" border=1 cellSpacing=0 borderColor=#666666>
                                        <TBODY>
                                          <TR> 
                                            <TD bgColor=#FFE9BB>
									...
									<TABLE borderColor=#666666 cellSpacing=0 border=1>
                                        <TBODY>
                                          <TR> 
                                            <TD bgColor=#FFE9BB>
											<p style="line-height: 200%; margin-top: 0; margin-bottom: 0">
		...
		<img border="0" src="fl/fot02.jpg" width="820" height="14"><STRONG><font color="#EBEBEB">¡¡¡¡</font></STRONG><div align="center">
								<table border="0" width="99%" height="32">
									<tr>
										...
										<p align="left" class="hl1"><b>¡¡¡¡¡¡<font color="#FFFFFF">ÏêÏ¸½éÉÜ</font></b></td>
									</tr>
								</table>
							</div>
                            <div align="center">
