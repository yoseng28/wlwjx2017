		...
		<div align="center">
            ...
            <TR> 
              <TD width="260" vAlign=top bgcolor="#FFFFFF"  style="BORDER-TOP: #808080 0px solid;BORDER-LEFT: #808080 0px solid;BORDER-right: #808080 1px solid;BORDER-bottom: #808080 0px solid;"> 
                ...
                <table border="0" width="240" cellspacing="0" height="567">
					<tr>
                      <TD height="60" align="center" bgcolor="#0099FF">
						<p class="anli" align="left"><font color="#4D4D4D">¡¡</font><font color="#FFFFFF">×îÐÂÊÓÆµ</font></TD>
                    </tr>
					...
					<tr>
                                      <TD align="left" height="40" background="bj.jpg" style="font-size: 10pt; line-height: 22px; font-family: arial">
										...
										<font color="#004993" face="Î¢ÈíÑÅºÚ">¡¡</font><font face="Î¢ÈíÑÅºÚ"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;</span></font><a style="text-decoration: none" href="zxktsp.asp?type=85">×îÐÂÊÓÆµ</a></TD>
  ...
  <TR bgcolor="#FFFFFF"> 
		...
		<img border="0" src="fl/fot02.jpg" width="820" height="24"></TD>
                      ...
                      <TABLE width=796 height=10 border=0 cellPadding=0 cellSpacing=1 bgcolor="#FFFFFF">
                        <TBODY>
                        <TR vAlign=top> 
                            <TD bgcolor="#FFFFFF" align="left"><p style="text-align: center">
							<object height="400" width="605" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" border="1">
...
<embed height="400" width="605" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" quality="High" flashvars="vcastr_file=<% =left(RS("ProductPrice4"),220) %>&amp;BufferTime=2&amp;isautoplay=1&amp;iscontinue=1" allowfullscreen="true" src="Flvplayer.swf" bgcolor="#ffffff"></embed></object></p>
							¡¡</TD>
                          </TR>
                          <TR vAlign=top> 
                            <TD 
