					...
					<tr>
                      <TD height="49" align="center" bgcolor="#0099FF">
						<p align="left" class="title" style="margin-top: 0; margin-bottom: 0">
										<font color="#006699" face="微软雅黑">　</font><span style="font-weight: 700"><font color="#FFFFFF" face="微软雅黑">科研情况</font></span></TD>
                    </tr>
					<tr>
                                  ...
                                  <TBODY>
                                    <TR> 
                                      <TD align="left" height="42" background="bj.jpg">
										...
										<font color="#004993" face="微软雅黑">　</font><font face="微软雅黑"><img border="0" src="images/about1.jpg" width="19" height="27"><span class="Apple-converted-space">&nbsp;&nbsp;</span><a style="text-decoration: none" href="keyan.asp?type=66">科研情况</a></font></TD>
                        ...
                        <TBODY>
                          <TR> 
                            <TD width="4%" height="30"> 
                              <div align="center">
								<img src="images/smallclasstb.gif" width="20" height="20"></div></TD>
                            <TD width="38%"><B><a  href="keyanlist.asp?type=<%=bigclass%>&type2=<%=rsSmallClass("SmallClassName")%>"><SPAN style="FONT-SIZE: 14px"><font color="205081"><%=rsSmallClass("SmallClassName")%></font></SPAN></a></B></TD>
                            <TD width="51%" align=middle>　</TD>
                            <TD width="7%"><a href="keyanlist.asp?type=<%=bigclassid%>&type2=<%=rsSmallClass("SmallClassid")%>">
							<IMG height=11 
...
for i=1 to 8
  if NOT oRS.EOF then
   %>
                              </span> <TABLE width="810" border="0" align="center" cellPadding=0 cellSpacing=0>
                                <TBODY>
                                  <TR> 
                                    <TD width=20 height="9" vAlign=middle class=listbg align="left">
									<p align="center">
									<img border="0" src="fl/icon03.gif" width="4" height="4"></TD>
                                    <TD width="679" height="30" class=listbg align="left"><a href="keyanview.asp?id=<% =ors("id") %>" > 
                                      <font color="#404A53"> 
                                      <% =ors("title") %>
                                      </font>
                                      </a>
									...
									<font color="#404A53">( 
                                      <% =year(ors("infotime")) %>-<% =month(ors("infotime")) %>- <% =day(ors("infotime")) %>)</font></TD>
                                  </TR>
                                  <TR> 
...
%>
                        ...
                        align=left width="682" class="shuye"> 
                                ...
                                <a href="keyanview.asp?id=<% =rs("id") %>" style="text-decoration: none" > 
                                <font face="微软雅黑" color="#404A53"> 
                                 <%=left(rs("title"),38)%>
                                </font>
                                </a></TD>
...
%>
                        ...
                        <CENTER>
                          <table width="710" border="0">
                            <tr> 
                              <td height="40" class="shuye"><div align="center"> 
                                  <font color="#515753" face="微软雅黑"> 
                                  <%if Page<2 then      
    response.write "首页 上一页&nbsp;"
  else
    response.write "<a href=keyan.asp?type="&bigclassid&"&type2="&smallclassid&"&page=1><FONT color=#ff0000>首页</FONT></a>&nbsp;"
    response.write "<a href=keyan.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & Page-1 & "><FONT color=#ff0000>上一页</FONT></a>&nbsp;"
  end if
  if rs.pagecount-page<1 then
    response.write "下一页 尾页"
  else
    response.write "<a href=keyan.asp?type="&bigclassid&"&type2="&smallclassid&"&page=" & (page+1) & ">"
    response.write "<FONT color=#ff0000>下一页</FONT></a> <a href=keyan.asp?type="&bigclassid&"&type2="&smallclassid&"&page="&rs.pagecount&"><FONT color=#ff0000>尾页</FONT></a>"
  end if
